...
**Наблюдения:**
- Исходный ряд: медленно убывающая ACF подтверждает нестационарность
- После d=2: значимые пики на лагах 11, 13, 23, 24 → годовая сезонность (s=12)
...
- Q-Q plot: точки близки к прямой линии
...
### График 1: SARIMA vs SARIMAX

<details>
<summary><b>📈 Развернуть график</b></summary>

![SARIMA vs SARIMAX](outputs/v2/05_sarimax_comparison.png)

**Наблюдения:**
- Доверительный интервал SARIMA(3,2,3)×(0,0,1,12) покрывает только часть фактических точек
- SARIMA прогноз идет близко от фактических значений
- SARIMAX (с экзогенными) прогнозные точки значительно выше SARIMA и реальных данных
- SARIMAX прогноз очень завышенный

</details>

### График 2: Ridge vs Комбинированная модель
...
- [ ] SARIMAX с сокращенным набором экзогенных переменных (5-10) — **будет ли в блоке 5?**
